          ...
          >
            <div>
              <h3
                ...
                className={`${
                  activeAccordion === 'accordion-flush-body-1' ? '' : 'collapsed'
                }`}
              >
                <button
                  type="button"
                ...
                >
                  <span>What programming languages should I learn as a beginner?</span>
                  <svg
                    data-accordion-icon=""
                    className={`w-6 h-6 ${
                      activeAccordion === 'accordion-flush-body-1' &&
              ...
              >
                <div className="py-5 border-b border-gray-200">
                  ...
                  As a beginner, it's recommended to start with popular and beginner-friendly languages like Python, JavaScript, or Java. These languages have extensive resources and communities that can help you learn and grow your coding skills.
                  </p>
            ...
            <div>
              <h3
                ...
                className={`${
                  activeAccordion === 'accordion-flush-body-2' ? '' : 'collapsed'
                }`}
              >
                <button
                  type="button"
              ...
              >
                <div className="py-5 border-b border-gray-200">
                  <p className="mb-2 text-gray-500">
                  Improving coding skills requires practice and dedication. Here are a few tips:
                  Practice regularly by solving coding problems and challenges.
                  Work on real-life projects to apply your knowledge.
            ...
            <div>
              <h3
                ...
                className={`${
                  activeAccordion === 'accordion-flush-body-3' ? '' : 'collapsed'
                }`}
              >
                <button
                  type="button"
                ...
                >
                  <span>What are some online resources for learning to code?</span>
                  <svg
                    data-accordion-icon=""
                    className={`w-6 h-6 ${
                      activeAccordion === 'accordion-flush-body-3' &&
              ...
              >
                <div className="py-5 border-b border-gray-200">
                  <p className="mb-2 text-gray-500">
                  There are numerous online platforms and resources available for learning to code. Some popular ones include:
                  Codecademy
                  FreeCodeCamp
                  Coursera
                  Udemy
            ...
            <div>
              <h3
                ...
                className={`${
                  activeAccordion === 'accordion-flush-body-4' ? '' : 'collapsed'
                }`}
              >
                <button
                  type="button"
              ...
              >
                <div className="py-5 border-b border-gray-200">
                  <p className="mb-2 text-gray-500">
                  Coding interviews often involve solving algorithmic and data structure problems. Here are a few tips to prepare:
                  </p>
                  ...
                  Mock interview with a friend or join coding interview preparation courses.
