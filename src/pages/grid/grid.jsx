...
import { CompressOutlined, DollarOutlined, HeartOutlined, TrophyOutlined, 
        SketchOutlined, RedditOutlined, RadarChartOutlined } from "@ant-design/icons";

const Grid = () => {
  return (
    <div className="container-grid">
      <div className="item-grid gr1 flex items-center justify-center">
        <CompressOutlined className="text-3xl md:text-5xl" />
      </div>
      ...
      <div className="item-grid gr6 flex items-center justify-center">
        <SketchOutlined className="text-3xl md:text-5xl" />
      </div>
      <div className="item-grid gr1 flex items-center justify-center">
